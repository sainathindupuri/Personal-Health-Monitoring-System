...
<h3 style="text-align: center;color: blue;font-family: Times New Roman Times, serif">Ranges of Tests</h3> -->
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-6 py-4">
              <div class="card h-100">
                <div class="card-body">
                  ...
                  <hr style="height:2px; color:#063970; background-color:#063970; width:70%; margin-left:0%">
                  <p class="card-text"> <b>Upcoming Medication</b></p>
                  <p class="card-text">
                  <ul>
                    <li>03/01/2022 6:30am - Insulin - 2 units<span>&#128154;</span></li>
                    <li>03/18/2022 7:30pm - Insulin - 2 units<span>&#128308;</span></li>
                  </ul>
